...
bool ChatHandler::HandleAddItemCommand(char* args)
{
    debug_log("***************************************************");
    debug_log("------------------------------------------------------------------------------------------*");
    debug_log("*************************** ATTEMPTING TO ADD AN ITEM TO THE CHAR ***************************************");
    debug_log("------------------------------------------------------------------------------------------*");
    debug_log("***************************************************");
    ...
    if (!ExtractUInt32(&cId, itemId))                       // [name] manual form
    {
        ...
        try
        {
            debug_log("*************************** ADDING %s TO THE CHAR BAG ***************************************", itemName);
        }
        catch (const char* msg)
        {    
            debug_log("problem outputting name of item!");
        }
        debug_log("------------------------------------------------------------------------------------------*");
...
bool ChatHandler::HandleLevelUpCommand(char* args)
{
    ...
    DEBUG_LOG("++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++");
    DEBUG_LOG("++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++");
    DEBUG_LOG("++++++++++++ TO THE MOOOOOOOOOOOOOOOOOOOON ++++++++++");
    DEBUG_LOG("++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++");
    DEBUG_LOG("++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++");
    DEBUG_LOG("++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++");
    DEBUG_LOG("++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++");
