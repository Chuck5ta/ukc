...
//    sAreaStore.GetFieldCount;
 //   sAreaStore.LookupEntry(0)[1];

    /*
    int input = 0;
    std::cout << "\n\nFILE NAME: " << sAreaStore.GetFieldCount();
    std::cin >> input;

    AreaTableEntry const* cAreaTableEntry = sAreaStore.LookupEntry(0);
    cAreaTableEntry->ID;
    sAreaStore.LookupEntry(0)->ID;
    sAreaStore.GetNumRows();
