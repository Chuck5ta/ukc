...
WDTFile::WDTFile(char* file_name, char* file_name1): gWmoInstansName(nullptr), gnWMO(0), nMaps(0), WDT(file_name)
{
...
bool WDTFile::init(char* map_id, unsigned int mapID)
{
    ...
    while (!WDT.isEof())
    {
        ...
        WDT.seek(static_cast<int>(nextpos));
    }
