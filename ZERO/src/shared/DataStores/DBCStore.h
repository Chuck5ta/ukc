    ...
    public:
        ...
        */
        ...
        bool Load(char const* fn)
        {
            ...
            m_dataTable = reinterpret_cast<T*>(dbc.AutoProduceData(fmt, nCount, reinterpret_cast<char**&>(indexTable)));

            // load strings from dbc data
            m_stringPoolList.push_back(dbc.AutoProduceStrings(fmt, reinterpret_cast<char*>(m_dataTable)));
        ...
        void Clear()
        {
            ...
            delete[]reinterpret_cast<char*>(indexTable);
            indexTable = NULL;
