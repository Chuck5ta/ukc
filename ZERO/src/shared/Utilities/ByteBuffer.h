...
class ByteBuffer
{
    public:
        ...
        {
            append(reinterpret_cast<uint8 const*>(value.c_str()), value.length());
        ...
        {
            append(reinterpret_cast<uint8 const*>(str), str ? strlen(str) : 0);
            append(static_cast<uint8>(0));
            return *this;
        }
        ...
        {
            append(reinterpret_cast<uint8 const*>(str.c_str()), str.size() + 1);
        }
